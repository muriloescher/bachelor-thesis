...
## 7) Minimal “quick reproduction” checklist

If you only want to regenerate tables and compile the thesis (without retraining models):
...
If you want to rerun experiments too:

1. Set up env (`pip install -r code/requirements.txt`)
2. (Optional) regenerate data via Section 2
3. Run experiments via Section 3
4. Generate thesis tables via Section 5
5. Compile thesis via Section 6
