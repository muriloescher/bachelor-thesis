...
For inflection, we evaluated a non-neural shared-task baseline, a neural transducer baseline, and fine-tuned ByT5 models, including a bidirectional variant trained on a mixture of forward and inverse examples. For analysis, we evaluated ByT5 models trained on UniMorph in the inverse direction and compared them to \ac{UD}-based context experiments, including a context-aware ByT5 model and prompting-based LLM baselines.
