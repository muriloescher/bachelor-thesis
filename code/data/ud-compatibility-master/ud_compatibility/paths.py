...
_ROOT = Path(__file__).parent.parent.parent / "ud"
UM_FOLDER = Path(__file__).parent.parent.parent / "unimorph"
UD_FOLDER = Path(__file__).parent.parent.parent / "ud"
UD2UM_FILE = Path(__file__).parent / "UD-UniMorph.tsv"
